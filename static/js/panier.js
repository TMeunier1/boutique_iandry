$(document).ready(function() {    var panier = JSON.parse(localStorage.getItem("panier"));
   for (var index in panier){
       var produit = catalog[index]
       var quantite = panier[index];        var main = $(".panier");
       ...
       var spanTotal = $("<span></span>");        sectionProduit.appendTo(main);
